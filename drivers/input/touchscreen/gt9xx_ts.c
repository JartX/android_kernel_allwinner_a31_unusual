...
//    u8 cfg_info_group3[] = CTP_CFG_GROUP3;
    u8 *send_cfg_buf[3] = {gt9xx_fw_grp[fw_index].data[0], cfg_info_group2, gt9xx_fw_grp[fw_index].data[2]};
    u8 cfg_info_len[3] = {gt9xx_fw_grp[fw_index].size[0], 
                          sizeof(cfg_info_group2)/sizeof(cfg_info_group2[0]),
                          gt9xx_fw_grp[fw_index].size[2]};
