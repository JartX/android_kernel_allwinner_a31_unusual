...
#include "gslX680_onda704q9.h"  //resolution:1280*800
#include "gslX680_onda804q9.h"  //resolution:1024*768
#include "gslX680_onda974q9.h"  //resolution:2048*1536
...
#include "gslX680_ondam1006q5.h"  //resolution:1024*768
#include  "gslX680_anpad-sc5083s.h" //resolution:768*1024
#include "gslX680_ondam704q6.h"  //resolution:1024*600
#include "gslX680_ondam809q5.h"  //resolution:1024*768
...
struct gslX680_fw_array {
	...
	{"gslX680_ondam1006q5", ARRAY_SIZE(GSLX680_FW_ONDAM1006Q5), GSLX680_FW_ONDAM1006Q5},
	{"gslX680_anpad-sc5083s", ARRAY_SIZE(GSLX680_FW_ANPAD_SC5083S), GSLX680_FW_ANPAD_SC5083S},
	{"gslx680_ondam704q6", ARRAY_SIZE(GSLX680_FW_ONDAM704Q6), GSLX680_FW_ONDAM704Q6},
	{"gslx680_onda704q9",  ARRAY_SIZE(GSLX680_FW_ONDA704Q9), GSLX680_FW_ONDA704Q9},
	{"gslx680_onda804q9",  ARRAY_SIZE(GSLX680_FW_ONDA804Q9), GSLX680_FW_ONDA804Q9},
	{"gslx680_onda974q9",  ARRAY_SIZE(GSLX680_FW_ONDA974Q9), GSLX680_FW_ONDA974Q9},
	{"gslx680_ondam809q5", ARRAY_SIZE(GSLX680_FW_ONDAM809Q5), GSLX680_FW_ONDAM809Q5},
...
static void gsl_load_fwx680(struct i2c_client *client)
{
	...
	if(read_buf[2] == 0x82)
	{
		fw = GSLX680E_FW_ONDAM704Q6;
		source_len = ARRAY_SIZE(GSLX680E_FW_ONDAM704Q6);	
	}
	else
#endif	
	{
		source_len = gslx680_fw_grp[fw_index].size;
		fw = gslx680_fw_grp[fw_index].fw;
	}
