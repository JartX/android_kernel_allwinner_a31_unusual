...
static int sensor_power(struct v4l2_subdev *sd, int on)
{
  ...
  switch(on)
  {
    case CSI_SUBDEV_STBY_ON:  /// Enter the standby mode
      vfe_dev_dbg("CSI_SUBDEV_STBY_ON\n");
      //standby on io
      vfe_gpio_write(sd,PWDN,CSI_STBY_ON);   // HIGH
      usleep_range(30000,31000);
      //inactive mclk after stadby in
      vfe_set_mclk(sd,OFF);
      break;
	  
    case CSI_SUBDEV_STBY_OFF:  // Operating Mode
      ...
      usleep_range(30000,31000);
      //standby off io
      vfe_gpio_write(sd,PWDN,CSI_STBY_OFF); //LOW
      usleep_range(10000,12000);
//			//reset off io
...
//			usleep_range(30000,31000);
    ...
    case CSI_SUBDEV_PWR_ON:
      ...
      vfe_gpio_write(sd,PWDN,CSI_STBY_ON);//HIGH
			//reset on io
      vfe_gpio_write(sd,RESET,CSI_RST_ON);//LOW
      //power supply
      ...
      vfe_gpio_write(sd,RESET,CSI_RST_ON);//LOW
			usleep_range(30000,31000);
			//reset off io
      vfe_gpio_write(sd,RESET,CSI_RST_OFF);//HIGH
			usleep_range(30000,31000);
			break;
