...
//  if( (gain_val*info->exp/info->current_wins->fps_fixed)<=((16*3/4)*8*info->current_wins->vts) )
//  {
//    printk("high light exp =%d gain =%d \n", info->exp/16, gain_val/16);
//    sensor_write(sd, 0x3036, 0x78);
//    info->current_wins->fps_fixed=1;
//  }
//  else if( (gain_val*info->exp/info->current_wins->fps_fixed)<=((16*3/4)*24*info->current_wins->vts) )
//  {
//    printk("mid light exp =%d gain =%d \n", info->exp/16, gain_val/16);
//    sensor_write(sd, 0x3036, 0x50);
//    info->current_wins->fps_fixed=1;
//  }
//  else
//  {
//    printk("low light exp =%d gain =%d \n", info->exp/16, gain_val/16);
//    sensor_write(sd, 0x3036, 0x32);
